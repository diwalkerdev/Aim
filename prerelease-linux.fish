...
eval $AIM_CMD build --target=builds/linux-clang++-debug calculatortests || exit
eval $AIM_CMD build --target=builds/linux-clang++-debug calculatorapp || exit
...
./builds/linux-clang++-debug/calculatortests/CalculatorTests || exit
./builds/linux-clang++-debug/calculatorapp/CalculatorApp || exit
